  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
        <a href="#"><img src="{{ asset('/theme/images/img_4.jpg') }}" alt="Image" class="img-fluid"></a>
      ...
      <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
        <a href="#"><img src="{{ asset('/theme/images/img_2.jpg') }}" alt="Image" class="img-fluid"></a>
        <div class="p-4 bg-white">
          <span class="d-block text-secondary small text-uppercase">Jan 20th, 2019</span>
          <h2 class="h5 text-black mb-3"><a href="#">Art Gossip by Mike Charles</a></h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias enim, ipsa exercitationem veniam quae sunt.</p>
      ...
      <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="300">
        <a href="#"><img src="{{ asset('/theme/images/img_3.jpg') }}" alt="Image" class="img-fluid"></a>
        <div class="p-4 bg-white">
          <span class="d-block text-secondary small text-uppercase">Jan 20th, 2019</span>
          <h2 class="h5 text-black mb-3"><a href="#">Art Gossip by Mike Charles</a></h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias enim, ipsa exercitationem veniam quae sunt.</p>
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
        <div class="team-member">
          ...
          <img src="{{ asset('/theme/images/person_1.jpg') }}" alt="Image" class="img-fluid rounded mb-4">
      ...
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
        <div class="team-member">
          ...
          <img src="{{ asset('/theme/images/person_2.jpg') }}" alt="Image" class="img-fluid rounded mb-4">
      ...
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
        <div class="team-member">
          ...
          <img src="{{ asset('/theme/images/person_3.jpg') }}" alt="Image" class="img-fluid rounded mb-4">
